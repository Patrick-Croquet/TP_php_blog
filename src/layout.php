...
<head>
    <meta charset="utf-8">
    <title>Eat + Travel + Shop - Un blog dédié aux plus grands plaisirs!</title>
...
<body>
    ...
    <header id="header" class="w-100 m-0 fixed-top" >
        <nav class="navbar navbar-expand-lg navbar-dark bgBlack w-100" style="background-color: black;">
            <a class="navbar-brand" href="index.php"><img class="h-25 w-25"src="images/logo/logoWhite.png" alt=""></a>
